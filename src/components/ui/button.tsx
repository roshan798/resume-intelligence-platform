...
// Fix 1: Extended the component props contract to accept optional 'asChild' parameter
...
function Button({
    ...
    variant = "default",
    size = "default",
    asChild = false, // Fix 2: Default asChild parameter to false
    ...props
}: ButtonProps) {
    // Fix 3: If asChild is true, bypass Base UI Primitive and render Radix Slot safely
